 ...
 * 修改内容：新增
 */
package CollectionUtils_Study;

import apache.commons.Student;
...
public class CollectionUtils_Study {
    ...
    public void CollectionUtilsTest() {
        ...
        // Predicate代码复用
        // age=30
        newStu2 = (List<Student>) CollectionUtils.select(listStu, new apache.commons.collections.CollectionUtils.MyPredicate(null, 30));
        newStu2.forEach(stu -> System.out.print(stu.getName() + " "));
        System.out.println();
        // name=A
        newStu2 = (List<Student>) CollectionUtils.select(listStu, new apache.commons.collections.CollectionUtils.MyPredicate("A", null));
        newStu2.forEach(stu -> System.out.print(stu.getName() + " "));
        System.out.println();
        // name=A,age=20
        newStu2 = (List<Student>) CollectionUtils.select(listStu, new apache.commons.collections.CollectionUtils.MyPredicate("A", 20));
        newStu2.forEach(stu -> System.out.print(stu.getName() + " "));
    }
}
